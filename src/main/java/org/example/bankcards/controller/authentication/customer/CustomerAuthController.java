package org.example.bankcards.controller.authentication.customer;

import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.example.api.CustomerAuthApi;
...
public class CustomerAuthController implements CustomerAuthApi {
    ...
    @Override
    public ResponseEntity<LoginResponse> loginCustomer(LoginRequest loginRequest) {
        try {
            String token = authService.customerAuthenticate(loginRequest.getLogin(),
